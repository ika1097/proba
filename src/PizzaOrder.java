...
public class PizzaOrder extends Application {
    ...
    CheckBox chkTomatoes;CheckBox chkAnchovies;
    ...
    public void start(Stage primaryStage) throws Exception {
        ...
        ToggleGroup groupChrust = new ToggleGroup();
        rdoThin.setToggleGroup(groupChrust);
        rdoThick.setToggleGroup(groupChrust);
        ...
        Scene scene =new Scene(paneMain,400,500);
